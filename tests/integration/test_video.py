...
class WikimediaVideoTest(WikimediaTestCase):
    ...
    def test_ogv(self):
        path = os.path.join(os.path.dirname(__file__), "originals", "2010-07-14-Blitze-Zeitlupe-1-08.ogg")
    ...
    def test_webm(self):
        path = os.path.join(os.path.dirname(__file__), "originals", "Aequipotentialflaechen.webm")
        ...
        path = os.path.join(os.path.dirname(__file__), "originals", "Cape_Town_under_the_clouds.webm")
        ...
        path = os.path.join(os.path.dirname(__file__), "originals", "Debris_flow_-_22_juillet_2013_-_Crue_torrentielle_a_Saint_Julien_Montdenis.webm")
    ...
    def test_non_square_pixels(self):
        path = os.path.join(os.path.dirname(__file__), "originals", "Malta-cat.ogv")
    ...
    def test_mpeg1(self):
        path = os.path.join(os.path.dirname(__file__), "originals", "Visualization-pone.0014754.s006.mpg")
    ...
    def test_mpeg2(self):
        path = os.path.join(os.path.dirname(__file__), "originals", "Folgers.mpg")
