...
class WikimediaPngTest(WikimediaTestCase):
    ...
    def test_transparent(self):
        self.run_and_check_ssim_and_size(
            "/thumbor/unsafe/400x/" + "PNG_transparency_demonstration_1.png",
        ...
        self.run_and_check_ssim_and_size(
            "/thumbor/unsafe/400x/filters:format(webp)/" + "PNG_transparency_demonstration_1.png",
            mediawiki_reference_thumbnail="400px-PNG_transparency_demonstration_1.png",
            perfect_reference_thumbnail="400px-PNG_transparency_demonstration_1.png",
            expected_width=400,
            expected_height=300,
        ...
        # Palette PNG
        self.run_and_check_ssim_and_size(
            "/thumbor/unsafe/400x/" + "Cincinnati_Bell_logo.png",
        ...
        self.run_and_check_ssim_and_size(
            "/thumbor/unsafe/400x/" + "Quillette.png",
        ...
        self.run_and_check_ssim_and_size(
            "/thumbor/unsafe/100x/" + "RGB_with_tRNS.png",
        ...
        self.run_and_check_ssim_and_size(
            "/thumbor/unsafe/100x/" + "Greyscale_with_tRNS.png",
