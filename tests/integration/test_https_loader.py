...
class WikimediaHttpsLoaderTest(WikimediaTestCase):
    ...
    def test_jpg(self):
        self.run_and_check_ssim_and_size(
            ("/thumbor/unsafe/400x/filters:conditional_sharpen(0.0,0.8,1.0,0.0,0.85)/https://upload.wikimedia.org/wikipedia/commons/6/6d/Christophe_Henner_-_June_2016.jpg"),
